...
int main() {
  ...
  // char cnew = 'z';
  // void * vptr = &cnew;
  // cout << "Char and its void pointer: '" << cnew << "' == '" << *(static_cast<char *>(vptr)) << "'; " << endl;
  // // cout << "Char and its void pointer: '" << cnew << "' == '" << *vptr << "'; " << endl;
  // // cvar = *vptr;
  ...
  // cout << "Unsigned integer variable: " << uivar << "; " << endl;
  // char cnew2;
  // cnew2 = *((char *) vptr); // C-like cast
  // cout << "Unsigned integer variable: " << cnew2 << "; " << endl;
  ...
  string&& stringa1 = g(); // Riferimento rvalue. (stesso oggetto)
  string stringa3 = std::move(g()); // Spostamento del valore. (stessa forma con spostamento)
  ...
  stringa1 = std::move(stringa2); // Dealloca il rvalue reference
  // stringa1 = stringa2; // la stessa cosa
